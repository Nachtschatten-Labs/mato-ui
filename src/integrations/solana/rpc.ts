...
type RpcHttpError = SolanaError<typeof SOLANA_ERROR__RPC__TRANSPORT_HTTP_ERROR>
...
export function getRpcTransportWithRateLimitRetry<
  TTransport extends RpcTransport,
>(transport: TTransport, options: RetryOptions = {}): TTransport {
